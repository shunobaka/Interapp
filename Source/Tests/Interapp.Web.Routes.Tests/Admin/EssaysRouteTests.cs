namespace Interapp.Web.Routes.Tests.Admin
{
    ...
    [TestFixture]
    public class EssaysRouteTests
    {
        [Test]
        public void TestRouteAdminEssaysIndex()
        {
            const string Url = "/Admin/Essays";
            ...
            routeCollection.ShouldMap(Url).To<EssaysController>(c => c.Index());
        }
    }
}
